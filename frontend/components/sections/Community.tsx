  ...
  const communityLinks = [
    {
      ...
      link: "https://github.com/abhishek-01k/desci-ai-researchgraph",
    ...
    },
    {
      ...
      link: "https://github.com/abhishek-01k/desci-ai-researchgraph#readme",
    ...
    },
    {
      ...
      link: "https://github.com/abhishek-01k/desci-ai-researchgraph/issues",
    ...
    },
    {
      ...
      link: "https://github.com/abhishek-01k/desci-ai-researchgraph/blob/main/CONTRIBUTING.md",
          ...
          <div className="glass-card p-8 rounded-lg max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button 
                ...
                onClick={() => window.open('https://github.com/abhishek-01k/desci-ai-researchgraph', '_blank')}
              >
